...
def sent_detector():
    """Procesa el texto enviado por el usuario y retorna el análisis emocional."""
    ...
    # Resultado final
    result_text = (
        f"Para la declaración dada, la respuesta del sistema es {all_scores}. "
...
def render_index_page():
    """Renderiza la página principal del proyecto."""
